...
//step3 create the statement object
	...
	String bdate = "";
	  ...
	  pst = con.prepareStatement("select venuename,address1, address2, city, state, country, ZIPCODE, contact, email,status_flag,image,vdate, status.venueid from address, status, venue where username = ?  and venue.ADDRESSID=address.ADDRESSID and venue.venueid=status.venueid"); 
	  pst.setString(1, username);
		...
		Vdate = rs.getString(12);
		venueid=rs.getInt(13);
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="row">
 							...
 							<a href="Cancel.jsp?username=<%=username%>&venueid=<%=venueid%>&bdate=<%=Vdate%> >" class="btn btn-default" style="min-width: 120px;">Cancel</a>
		
				 </div>
								</div>
								<%-- <div class="col-md-6">
								
									<i class="row sitemap">date booked = <%=Vdate%></i>
	...
	<footer class="footer container">
		<div class="row sitemap">
			<div class="col-md-2">
				<b> LOCATIONS </b><br> <a
					href="http://partynplace.com/location/city/hyderabad">chicago</a>
				<a href="http://partynplace.com/location/city/chennai">new york</a> <a
					href="http://partynplace.com/location/city/mumbai">miami</a> <a
					href="http://partynplace.com/location/city/dheli">new jersy</a> <a
					href="http://partynplace.com/location/city/banglore">baltimore</a>
			</div>
			<div class="col-md-2">
