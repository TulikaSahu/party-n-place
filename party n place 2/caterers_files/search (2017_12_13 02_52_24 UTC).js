$(document).ready(function(){
	...
	site_url = "http://www.partynplace.com/";
	var loc = new String();
	...
	$.ajax({
		url: "http://WWW.partynplace.com/search/locations/",
		method : "GET"
	}).success(function(data) {
		$("#locations").html(data);
	});
	$.ajax({
		url: "http://www.partynplace.com/search/venuetypes/",
		method : "GET"
	}).success(function(data) {
		$("#vtypes").html(data);
	});
	$("#slocation").change(function(){
		slocation = $(this).val(); 
		$.ajax({
			url: "http://www.partynplace.com/search/locations/"+slocation+"/",
			method : "GET"
		}).success(function(data) {
			$("#locations").html(data);
		});
	...
	$("#svenuetype").change(function(){
		svkey = $(this).val(); 
		$.ajax({
			url: "http://www.partynplace.com/search/venuetypes/"+svkey+"/",
			method : "GET"
		}).success(function(data) {
			$("#vtypes").html(data);
		});
	...
	function searchnow() {
		...
		searchurl = "http://www.partynplace.com/search/all";
		$.ajax({
			url: searchurl,
			async : false,
			method : "POST",
