...
//step3 create the statement object
	...
	String catererId="";
	  ...
	  pst = con.prepareStatement("select caterername,address1, address2, city, state, country, ZIPCODE, contact, email, Image, catererid from address, caterlist where caterlist.ADDRESSID=address.ADDRESSID"); 
		
		ResultSet rs = pst.executeQuery();              
		while(rs.next()) {          
		 caterername = rs.getString(1) ;
