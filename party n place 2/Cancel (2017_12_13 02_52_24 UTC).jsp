...
//step3 create the statement object  
	...
	String pswd = request.getParameter("venueid");
	String email = request.getParameter("bdate");
...
/* 	long phone = Long.parseLong(request.getParameter("phone")); */
	...
	"jdbc:oracle:thin:@www.papademas.net:1521:orcl","ora_smamidi1","oracle"); 
	 ...
	 PreparedStatement pst = con.prepareStatement("select * from status where username = ?"); 
